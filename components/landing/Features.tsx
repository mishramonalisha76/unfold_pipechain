...
function Features() {
  return (
    ...
    <div className="flex m-16 mx-40 my-40 gap-10 items-center justify-center text-white">
      <div
        className="flex flex-col items-center gap-4 bg-indigo-900 p-8 shadow-xl transform 
      ...
      <div
        className="flex flex-col items-center gap-4 bg-indigo-300 p-8 transform shadow-xl
                                transition duration-500 hover:scale-110"
      >
      ...
      <div className="flex flex-col items-center gap-4 bg-yellow-400 p-8 transform shadow-xl
                                transition duration-500 hover:scale-110">
